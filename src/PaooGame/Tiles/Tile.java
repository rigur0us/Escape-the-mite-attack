...
public class Tile
{
    ...
    public static Tile MainCharacter = new MainCh( 5);
                           /*!< Inaltimea unei dale.*/
    public static final int TileAdjust = 3;
    public static final int TILE_WIDTH  = 16 * TileAdjust;                       /*!< Latimea unei dale.*/
    public static final int TILE_HEIGHT = 16 * TileAdjust;
